    ...
    extend: {
      ...
      keyframes: {
        ...
        glitch: {
          ...
          '66%': { opacity: '0.9', transform: 'translate(-1px, -2px)' },
        },
      },
      backgroundImage: {
        'gradient-radial': 'radial-gradient(var(--tw-gradient-stops))',
        'neural-grid': 'linear-gradient(rgba(0,240,255,0.03) 1px, transparent 1px), linear-gradient(90deg, rgba(0,240,255,0.03) 1px, transparent 1px)',
      },
    },
  },
  plugins: [],
